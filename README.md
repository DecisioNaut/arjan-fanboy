...
└── example/                     # Live refactoring demonstration
    ├── README.md                # Guide to the experiment
    ├── before.py                # Original code (anti-patterns)
    ├── after.py                 # Manually refactored code
    ├── after-using-arjan-fanboy.py  # AI refactored using this skill
    └── ARJAN-FANBOYS-PERSPECTIVE.md # Analysis and insights
```
...
## Live Example: Skill in Action

The `example/` folder contains a small experiment demonstrating this skill's behavior on a real code snippet from Arjan's repositories. It includes:

- **before.py** - Original code to be refactored, containing common anti-patterns and design issues.
- **after-using-arjan-fanboy.py** - Code refactored using the arjan-fanboy skill, showing how the AI applied the principles and patterns to achieve a similar result.
- **after.py** - Arjan's original refactored version from 5 years ago.
- **ARJAN-FANBOYS-PERSPECTIVE.md** - Analysis comparing the approaches and insights from the skill's guidance (generated by the helf of the arjan-fanboy skill)
